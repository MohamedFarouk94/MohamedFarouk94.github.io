...
This is my personal portfolio site. No framework, no build step — just HTML, CSS, and vanilla JS.

Live at: https://mohamedfarouk94.github.io/
...
There's nothing to build. Just open `index.html` in a browser.
...
Feel free to poke around the code for ideas, but the content (About text, project descriptions, etc.) is mine — please don't copy it verbatim for your own portfolio.
